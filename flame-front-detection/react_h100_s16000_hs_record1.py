...
T_lab = 273.15 + 23.7                                           # units: K   
p_lab = 102.75e3                                                # units: Pa
D_in = 25.16                                                    # units: mm
...
Re_D = 16000
u_bulk_measured = 11.55                                         # units: m.s^{-1}
run_nr = 31
session_nr = 4                                                    
record_name = 'Recording_Date=230623_Time=130451_01'            
frame_nrs = [0, 1]                                              
scale = 15.05                                                   # units: pixels.mm^{-1}
start_image = 1                                                 
n_images = 6000                                                    
