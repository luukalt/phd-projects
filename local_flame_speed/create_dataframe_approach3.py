...
selected_segment: 0
x_intersect_ref_advected: 1
y_intersect_ref_advected: 2
x_intersect: 3
y_intersect: 4
i_segment: 5
...
from local_flame_speed_approach3 import *
...
def create_dataframe(method_key=0, last_image_nr=1000, n_nearest_coords=1, threshold_angle=180, spline_skip_length_mm=4):
    ...
    for image_nr in tqdm(image_nrs):
        ...
        for final_segment in final_segments:
            ...
            x_intersect_t0 = final_segment[0][19]
            y_intersect_t0 = final_segment[0][20]
            S_a = final_segment[8]
            S_d = final_segment[9]
    ...
    fname = f"advec_segm_len_{flame.segment_length_mm}mm_wsize_{flame.window_size}pxl_spline_skip_len_{skip_coords}mm_{last_image_nr}"
