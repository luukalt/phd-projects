...
def wall_detection(pre_record_dir, day_nr):
    ...
    y_start_core_left = 230
    y_stop_core_left = 260
    
    wall_coords_core_left = []
    
    for i in range(0, 350, 1): #380
    ...
    string = str(pt1_core_left_mask[0]) + " " + str(pt1_core_left_mask[1]) + " "
...
if __name__ == "__main__":
    ...
    pt1_liner, pt2_liner, pt1_core_left, pt2_core_left, pt1_core_right, pt2_core_right, cx, cy, radius = wall_detection(pre_record_raw_dir, day_nr)
    
    # wall_detection(pre_record_raw_dir)
