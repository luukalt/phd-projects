...
from plot_functions import plot_cartoons, plot_cartoons_flashback, plot_streamlines_reacting_flow, plot_streamlines_nonreacting_flow, plot_mass_cons, plot_ns_terms, plot_pressure_along_streamline, plot_mass_cons_old
...
if __name__ == '__main__':
    ...
    for ii, values in enumerate(values_list):
        ...
        if ii == 0:
            ...
            image_nrs = [3169, 3171, 3173, 3175, 3177] # DNG-2700
            # image_nrs = [85, 86, 87, 88, 89] # H2-11900
            ...
            for image_i, ax_i in enumerate(axs.ravel()):
                ...
                plot_cartoons_flashback(flame, ax_i, image_nrs, image_nr, recording,  D_in, offset_to_wall_center, offset)
                
                if image_i in [1, 2, 3, 4, 5]:
                    ax_i.set_ylabel('')
                    ax_i.tick_params(axis='y', labelleft=False)
                
                # if image_i in [0, 1, 2, 3, 4, 5]:
                #     ax_i.set_xlabel('')
            ...
            filename = f'H{flame.H2_percentage}_Re{flame.Re_D}_sequence1test'
